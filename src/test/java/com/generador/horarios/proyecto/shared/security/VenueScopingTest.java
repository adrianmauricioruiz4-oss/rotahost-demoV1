...
class VenueScopingTest {
    ...
    void managerCannotCreateEmployeeInAnotherVenue() {
        EmployeeRequest request = new EmployeeRequest(
                "Intruso", "intruso." + UUID.randomUUID() + "@test.com", ContractType.FULL_TIME, null, venueB.getId());
    ...
    void managerCannotEditEmployeeOfAnotherVenue() {
        EmployeeRequest request = new EmployeeRequest(
                employeeB.getName(), employeeB.getEmail(), ContractType.FULL_TIME, null, venueB.getId());
