...
### Fase 1 — Cimientos
- [ ] T1.1 — `./mvnw` init, `pom.xml`, estructura de paquetes, `application.yml` (MySQL + perfil `test` con H2), `.gitignore`
...
- [ ] T2.6 — Equidad con histórico de 3 semanas (S2) + informe de equidad
